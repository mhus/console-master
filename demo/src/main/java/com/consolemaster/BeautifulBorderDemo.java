...
public class BeautifulBorderDemo {
    ...
    public static void main(String[] args) {
        try {
            ...
            Text text1 = new Text("text1", 0, 0, 16, 3, "Standard UTF-8\nBorder with\nbeautiful lines");
            text1.setForegroundColor(AnsiColor.BRIGHT_CYAN);
            Box box1 = new Box("box1", 2, 2, 20, 5, new DefaultBorder());
            box1.setChild(text1);

            // Colored Border
            Text text2 = new Text("text2", 0, 0, 16, 3, "Colored Border\nin bright green\nwith style");
            text2.setForegroundColor(AnsiColor.WHITE);
            DefaultBorder greenBorder = new DefaultBorder(AnsiColor.BRIGHT_GREEN);
            Box box2 = new Box("box2", 25, 2, 20, 5, greenBorder);
            box2.setChild(text2);

            // Bold Border
            Text text3 = new Text("text3", 0, 0, 16, 3, "Bold Border\nwith formatting\nand emphasis");
            ...
            Box box3 = new Box("box3", 48, 2, 20, 5, boldBorder);
            box3.setChild(text3);

            // Nested Boxes
            Text innerText = new Text("innerText", 0, 0, 12, 2, "Inner Box\nNested!");
            innerText.setForegroundColor(AnsiColor.BRIGHT_MAGENTA);
            DefaultBorder innerBorder = new DefaultBorder(AnsiColor.CYAN);
            Box innerBox = new Box("innerBox", 1, 1, 16, 4, innerBorder);
            innerBox.setChild(innerText);

            Text outerText = new Text("outerText", 0, 0, 20, 1, "Outer Box Container");
            ...
            Box outerBox = new Box("outerBox", 2, 10, 24, 9, outerBorder);
            outerBox.setChild(outerContent);

            // Multiple styles showcase
            Text styleText = new Text("styleText", 0, 0, 20, 5,
                "UTF-8 Box Drawing:\n" +
                "┌─ Top-left\n" +
                "│  Vertical lines\n" +
                "─  Horizontal lines\n" +
            ...
            Box styleBox = new Box("styleBox", 30, 10, 24, 7, styleBorder);
            ...
            // Title
            Text title = new Text("title", 0, 0, 80, 1, "Beautiful UTF-8 Box-Drawing Borders Demo - Press any key to exit");
