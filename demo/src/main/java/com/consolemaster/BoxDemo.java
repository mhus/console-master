...
public class BoxDemo {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Simple border box
            Box simpleBox = new Box("simpleBox", 0, 0, 20, 5, new DefaultBorder());
            Text simpleText = new Text("simpleText", 0, 0, 0, 0, "Simple Border", Text.Alignment.CENTER);
            simpleText.setForegroundColor(AnsiColor.WHITE);
            simpleBox.setChild(simpleText);
            content.addChild(simpleBox);

            // Thick border box
            Box thickBox = new Box("thickBox", 0, 0, 20, 5, new DefaultBorder(BorderStyle.THICK));
            Text thickText = new Text("thickText", 0, 0, 0, 0, "Thick Border", Text.Alignment.CENTER);
            ...
            Box coloredBox = new Box("coloredBox", 0, 0, 20, 5, coloredBorder);
            Text coloredText = new Text("coloredText", 0, 0, 0, 0, "Colored Border", Text.Alignment.CENTER);
            ...
            Box multiBox = new Box("multiBox", 0, 0, 25, 6, new DefaultBorder());
            Text multiText = new Text("multiText", 0, 0, 0, 0, "Multi-line\nContent\nBox", Text.Alignment.CENTER);
