...
public class BorderStyleDemo {
    ...
    public static void main(String[] args) {
        try {
            ...
            CompositeCanvas main = new CompositeCanvas(0, 0, 80, 30);

            // Title
            Text title = new Text(0, 0, 80, 1, "BorderStyle Demo - Beautiful UTF-8 Box-Drawing Characters");
            ...
            Text demoText = new Text(0, 0, 30, 6,
            ...
            Box demoBox = new Box(38, 12, 34, 8, demoBorder);
            demoBox.setChild(demoText);
            main.addChild(demoBox);

            // Character showcase
            Text charInfo = new Text(0, 0, 76, 6,
            ...
            Box infoBox = new Box(2, 22, 76, 6, infoBorder);
     ...
     */
    private static void createBorderExample(CompositeCanvas parent, int x, int y, String label, BorderStyle style, AnsiColor color) {
        Text text = new Text(0, 0, 14, 2, label);
        text.setForegroundColor(color);
        text.setAlignment(Text.Alignment.CENTER);

        DefaultBorder border = new DefaultBorder(style, color);
        Box box = new Box(x, y, 16, 4, border);
        box.setChild(text);
