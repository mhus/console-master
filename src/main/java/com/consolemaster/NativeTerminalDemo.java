...
public class NativeTerminalDemo {
    ...
    public static void main(String[] args) {
        try {
            ...
            Composite borderContainer = new Composite("BorderContainer", 2, 2,
                                                                 screen.getWidth() - 4,
                                                                 screen.getHeight() - 4,
                                                                 new BorderLayout(1));

            // Create NORTH component (Header)
            Box northBox = new Box("NorthBox", 0, 0, 0, 3, new DefaultBorder());
            Text northText = new Text("NorthText", 0, 0, 0, 0, "NORTH - Native Terminal Demo", Text.Alignment.CENTER);
            ...
            Box southBox = new Box("SouthBox", 0, 0, 0, 3, new DefaultBorder());
            Text southText = new Text("SouthText", 0, 0, 0, 0, "SOUTH - Press 'q' to quit, TAB to navigate", Text.Alignment.CENTER);
            ...
            Box westBox = new Box("WestBox", 0, 0, 20, 0, new DefaultBorder());
            Composite westContent = new Composite("WestContent", 0, 0, 0, 0, new FlowLayout(1, 1));

            Text westTitle = new Text("WestTitle", 0, 0, 0, 1, "WEST Sidebar:", Text.Alignment.LEFT);
            ...
            Text westInfo1 = new Text("WestInfo1", 0, 0, 0, 1, "• Native ANSI", Text.Alignment.LEFT);
            westInfo1.setForegroundColor(AnsiColor.WHITE);
            westContent.addChild(westInfo1);

            Text westInfo2 = new Text("WestInfo2", 0, 0, 0, 1, "• No JLine deps", Text.Alignment.LEFT);
            westInfo2.setForegroundColor(AnsiColor.WHITE);
            westContent.addChild(westInfo2);

            Text westInfo3 = new Text("WestInfo3", 0, 0, 0, 1, "• Full keyboard", Text.Alignment.LEFT);
            westInfo3.setForegroundColor(AnsiColor.WHITE);
            westContent.addChild(westInfo3);

            Text westInfo4 = new Text("WestInfo4", 0, 0, 0, 1, "• Mouse support", Text.Alignment.LEFT);
            ...
            Box eastBox = new Box("EastBox", 0, 0, 20, 0, new DefaultBorder());
            Composite eastContent = new Composite("EastContent", 0, 0, 0, 0, new FlowLayout(1, 1));

            Text eastTitle = new Text("EastTitle", 0, 0, 0, 1, "EAST Status:", Text.Alignment.LEFT);
            ...
            Text statusText = new Text("StatusText", 0, 0, 0, 1, "Terminal Ready", Text.Alignment.LEFT);
            statusText.setForegroundColor(AnsiColor.BRIGHT_GREEN);
            eastContent.addChild(statusText);

            Text sizeText = new Text("SizeText", 0, 0, 0, 1,
            ...
            Box centerBox = new Box("CenterBox", 0, 0, 0, 0, new DefaultBorder());
            Composite centerContent = new Composite("CenterContent", 0, 0, 0, 0, new FlowLayout(2, 2));

            Text centerTitle = new Text("CenterTitle", 0, 0, 0, 2, "CENTER - Native Terminal Implementation", Text.Alignment.CENTER);
            ...
            Text infoText1 = new Text("InfoText1", 0, 0, 0, 1, "This demo shows the framework running completely", Text.Alignment.CENTER);
            infoText1.setForegroundColor(AnsiColor.WHITE);
            centerContent.addChild(infoText1);

            Text infoText2 = new Text("InfoText2", 0, 0, 0, 1, "without JLine dependencies!", Text.Alignment.CENTER);
            infoText2.setForegroundColor(AnsiColor.BRIGHT_GREEN);
            infoText2.setFormats(AnsiFormat.BOLD);
            centerContent.addChild(infoText2);

            Text controlsTitle = new Text("ControlsTitle", 0, 0, 0, 2, "Controls:", Text.Alignment.CENTER);
            ...
            Text control1 = new Text("Control1", 0, 0, 0, 1, "TAB/Shift+TAB - Navigate focus", Text.Alignment.CENTER);
            control1.setForegroundColor(AnsiColor.CYAN);
            centerContent.addChild(control1);

            Text control2 = new Text("Control2", 0, 0, 0, 1, "Arrow keys - Navigate", Text.Alignment.CENTER);
            control2.setForegroundColor(AnsiColor.CYAN);
            centerContent.addChild(control2);

            Text control3 = new Text("Control3", 0, 0, 0, 1, "F1-F12 - Function keys", Text.Alignment.CENTER);
            control3.setForegroundColor(AnsiColor.CYAN);
            centerContent.addChild(control3);

            Text control4 = new Text("Control4", 0, 0, 0, 1, "'q' or ESC - Quit", Text.Alignment.CENTER);
